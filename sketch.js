...
upIng = loadImage("up.png")
alienShipImg = loadImage("alienShip.png")
}
...
function draw() {
    ...
    if (gameState === "play") {
     ...
     // }
      ...
      if (upGroup.isTouching(spaceship)) {
        console.log()
        upGroup.destroy();
        spaceship.depth = up.depth+1
      }
...
function spawnAlienShip() {
  ...
  var alienShip = createSprite(random(50,590),0,50,50)  
  alienShip.addImage(alienShipImg)
  alienShip.velocityY = 3
